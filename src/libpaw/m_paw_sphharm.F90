...
!public procedures.
 ...
 public :: set_x_nabla_ylm    ! Compute x_rotation matrices expressed in the basis of real spherical harmonics
...
!      MM030519 : abs is needed to prevent very small negative arg
       ...
       do mm=1,mpsang-1
         rphase(mm)=real(cmplx(cphi,sphi, kind=kind(1.0d0))**mm)
         iphase(mm)=aimag(cmplx(cphi,sphi, kind=kind(1.0d0))**mm)
       end do
...
!!***
!----------------------------------------------------------------------
 subroutine set_x_nabla_ylm(ang_phixpphj,mpsang)
!! FUNCTION
!! Evaluate several more integrals involving spherical harmonics and their gradient.
!! These integrals are angular part for <phi_i|r_a nabla_b|phi_j> and <tphi_i|r_a nabla_b|tphi_j>.
!!
!! INPUTS
!!  mpsang=1+ max. angular momentum
!!
!! OUTPUT
!!  ang_phipphj :: angular part for <phi_i|nabla|phi_j> and <tphi_i|nabla|tphi_j>
!!  ang_phipphj(i,j,1)=\int sin^2\theta cos^2\phi Si Sj d\omega
!!  ang_phipphj(i,j,2)=\int sin^2\theta sin\phi cos\phi Si Sj d\omega
!!
  !Arguments ------------------------------------
  !scalars
   integer,intent(in) :: mpsang
  !arrays
   real(dp),intent(out) :: ang_phixpphj(mpsang**2,mpsang**2,24)
  
  !Local variables-------------------------------
   character(len=500) :: msg
   real(dp) :: ang_phixpphj_tmp(16,16,24)
  ...
  ang_phixpphj_tmp=zero

  ang_phixpphj_tmp(1,1,1)=0.33333333333333333333_dp
  ang_phixpphj_tmp(1,7,1)=-0.14907119849998597976_dp
  ang_phixpphj_tmp(1,9,1)=0.25819888974716112568_dp
  ang_phixpphj_tmp(2,2,1)=0.20000000000000000000_dp
  ang_phixpphj_tmp(2,10,1)=0.20701966780270626534_dp
  ang_phixpphj_tmp(2,12,1)=-0.053452248382484876937_dp
  ang_phixpphj_tmp(3,3,1)=0.20000000000000000000_dp
  ang_phixpphj_tmp(3,13,1)=-0.13093073414159542876_dp
  ang_phixpphj_tmp(3,15,1)=0.16903085094570331550_dp
  ang_phixpphj_tmp(4,4,1)=0.60000000000000000000_dp
  ang_phixpphj_tmp(4,14,1)=-0.16035674514745463081_dp
  ang_phixpphj_tmp(4,16,1)=0.20701966780270626534_dp
  ang_phixpphj_tmp(5,5,1)=0.42857142857142857143_dp
  ang_phixpphj_tmp(6,6,1)=0.14285714285714285714_dp
  ang_phixpphj_tmp(7,1,1)=-0.14907119849998597976_dp
  ang_phixpphj_tmp(7,7,1)=0.23809523809523809524_dp
  ang_phixpphj_tmp(7,9,1)=-0.16495721976846450415_dp
  ang_phixpphj_tmp(8,8,1)=0.42857142857142857143_dp
  ang_phixpphj_tmp(9,1,1)=0.25819888974716112568_dp
  ang_phixpphj_tmp(9,7,1)=-0.16495721976846450415_dp
  ang_phixpphj_tmp(9,9,1)=0.42857142857142857143_dp
  ang_phixpphj_tmp(10,2,1)=0.20701966780270626534_dp
  ang_phixpphj_tmp(10,10,1)=0.44444444444444444444_dp
  ang_phixpphj_tmp(10,12,1)=-0.086066296582387041893_dp
  ang_phixpphj_tmp(11,11,1)=0.33333333333333333333_dp
  ang_phixpphj_tmp(12,2,1)=-0.053452248382484876937_dp
  ang_phixpphj_tmp(12,10,1)=-0.086066296582387041893_dp
  ang_phixpphj_tmp(12,12,1)=0.13333333333333333333_dp
  ang_phixpphj_tmp(13,3,1)=-0.13093073414159542876_dp
  ang_phixpphj_tmp(13,13,1)=0.24444444444444444444_dp
  ang_phixpphj_tmp(13,15,1)=-0.17213259316477408379_dp
  ang_phixpphj_tmp(14,4,1)=-0.16035674514745463081_dp
  ang_phixpphj_tmp(14,14,1)=0.40000000000000000000_dp
  ang_phixpphj_tmp(14,16,1)=-0.086066296582387041893_dp
  ang_phixpphj_tmp(15,3,1)=0.16903085094570331550_dp
  ang_phixpphj_tmp(15,13,1)=-0.17213259316477408379_dp
  ang_phixpphj_tmp(15,15,1)=0.33333333333333333333_dp
  ang_phixpphj_tmp(16,4,1)=0.20701966780270626534_dp
  ang_phixpphj_tmp(16,14,1)=-0.086066296582387041893_dp
  ang_phixpphj_tmp(16,16,1)=0.44444444444444444444_dp
  
  !!!
  ang_phixpphj_tmp(1,5,2)=0.25819888974716112567_dp
  ang_phixpphj_tmp(2,4,2)=0.20000000000000000000_dp
  ang_phixpphj_tmp(2,14,2)=-0.053452248382484876936_dp
  ang_phixpphj_tmp(2,16,2)=-0.20701966780270626533_dp
  ang_phixpphj_tmp(3,11,2)=0.16903085094570331550_dp
  ang_phixpphj_tmp(4,2,2)=0.20000000000000000000_dp
  ang_phixpphj_tmp(4,10,2)=0.20701966780270626533_dp
  ang_phixpphj_tmp(4,12,2)=-0.053452248382484876936_dp
  ang_phixpphj_tmp(5,1,2)=0.25819888974716112567_dp
  ang_phixpphj_tmp(5,7,2)=-0.16495721976846450414_dp
  ang_phixpphj_tmp(6,8,2)=0.14285714285714285714_dp
  ang_phixpphj_tmp(7,5,2)=-0.16495721976846450414_dp
  ang_phixpphj_tmp(8,6,2)=0.14285714285714285714_dp
  ang_phixpphj_tmp(10,4,2)=0.20701966780270626533_dp
  ang_phixpphj_tmp(10,14,2)=-0.086066296582387041892_dp
  ang_phixpphj_tmp(11,3,2)=0.16903085094570331550_dp
  ang_phixpphj_tmp(11,13,2)=-0.17213259316477408378_dp
  ang_phixpphj_tmp(12,4,2)=-0.053452248382484876936_dp
  ang_phixpphj_tmp(12,14,2)=0.13333333333333333333_dp
  ang_phixpphj_tmp(12,16,2)=0.086066296582387041892_dp
  ang_phixpphj_tmp(13,11,2)=-0.17213259316477408378_dp
  ang_phixpphj_tmp(14,2,2)=-0.053452248382484876936_dp
  ang_phixpphj_tmp(14,10,2)=-0.086066296582387041892_dp
  ang_phixpphj_tmp(14,12,2)=0.13333333333333333333_dp
  ang_phixpphj_tmp(16,2,2)=-0.20701966780270626533_dp
  ang_phixpphj_tmp(16,12,2)=0.086066296582387041892_dp
  !!!!!
  ang_phixpphj_tmp(1,8,3)=0.25819888974716112568_dp
  ang_phixpphj_tmp(2,11,3)=0.16903085094570331550_dp
  ang_phixpphj_tmp(3,4,3)=0.20000000000000000000_dp
  ang_phixpphj_tmp(3,14,3)=0.21380899352993950775_dp
  ang_phixpphj_tmp(4,3,3)=0.20000000000000000000_dp
  ang_phixpphj_tmp(4,13,3)=-0.13093073414159542876_dp
  ang_phixpphj_tmp(4,15,3)=0.16903085094570331550_dp
  ang_phixpphj_tmp(5,6,3)=0.14285714285714285714_dp
  ang_phixpphj_tmp(6,5,3)=0.14285714285714285714_dp
  ang_phixpphj_tmp(7,8,3)=0.082478609884232252073_dp
  ang_phixpphj_tmp(8,1,3)=0.25819888974716112568_dp
  ang_phixpphj_tmp(8,7,3)=0.082478609884232252073_dp
  ang_phixpphj_tmp(8,9,3)=0.14285714285714285714_dp
  ang_phixpphj_tmp(9,8,3)=0.14285714285714285714_dp
  ang_phixpphj_tmp(10,11,3)=0.13608276348795433879_dp
  ang_phixpphj_tmp(11,2,3)=0.16903085094570331550_dp
  ang_phixpphj_tmp(11,10,3)=0.13608276348795433879_dp
  ang_phixpphj_tmp(11,12,3)=0.10540925533894597773_dp
  ang_phixpphj_tmp(12,11,3)=0.10540925533894597773_dp
  ang_phixpphj_tmp(13,4,3)=-0.13093073414159542876_dp
  ang_phixpphj_tmp(13,14,3)=0.054433105395181735515_dp
  ang_phixpphj_tmp(14,3,3)=0.21380899352993950775_dp
  ang_phixpphj_tmp(14,13,3)=0.054433105395181735515_dp
  ang_phixpphj_tmp(14,15,3)=0.10540925533894597773_dp
  ang_phixpphj_tmp(15,4,3)=0.16903085094570331550_dp
  ang_phixpphj_tmp(15,14,3)=0.10540925533894597773_dp
  ang_phixpphj_tmp(15,16,3)=0.13608276348795433879_dp
  ang_phixpphj_tmp(16,15,3)=0.13608276348795433879_dp
  !!!!!
  
  ang_phixpphj_tmp(1,5,4)=0.25819888974716112568_dp
  ang_phixpphj_tmp(2,4,4)=0.20000000000000000000_dp
  ang_phixpphj_tmp(2,14,4)=-0.053452248382484876937_dp
  ang_phixpphj_tmp(2,16,4)=-0.20701966780270626534_dp
  ang_phixpphj_tmp(3,11,4)=0.16903085094570331550_dp
  ang_phixpphj_tmp(4,2,4)=0.20000000000000000000_dp
  ang_phixpphj_tmp(4,10,4)=0.20701966780270626534_dp
  ang_phixpphj_tmp(4,12,4)=-0.053452248382484876937_dp
  ang_phixpphj_tmp(5,1,4)=0.25819888974716112568_dp
  ang_phixpphj_tmp(5,7,4)=-0.16495721976846450415_dp
  ang_phixpphj_tmp(6,8,4)=0.14285714285714285714_dp
  ang_phixpphj_tmp(7,5,4)=-0.16495721976846450415_dp
  ang_phixpphj_tmp(8,6,4)=0.14285714285714285714_dp
  ang_phixpphj_tmp(10,4,4)=0.20701966780270626534_dp
  ang_phixpphj_tmp(10,14,4)=-0.086066296582387041893_dp
  ang_phixpphj_tmp(11,3,4)=0.16903085094570331550_dp
  ang_phixpphj_tmp(11,13,4)=-0.17213259316477408379_dp
  ang_phixpphj_tmp(12,4,4)=-0.053452248382484876937_dp
  ang_phixpphj_tmp(12,14,4)=0.13333333333333333333_dp
  ang_phixpphj_tmp(12,16,4)=0.086066296582387041893_dp
  ang_phixpphj_tmp(13,11,4)=-0.17213259316477408379_dp
  ang_phixpphj_tmp(14,2,4)=-0.053452248382484876937_dp
  ang_phixpphj_tmp(14,10,4)=-0.086066296582387041893_dp
  ang_phixpphj_tmp(14,12,4)=0.13333333333333333333_dp
  ang_phixpphj_tmp(16,2,4)=-0.20701966780270626534_dp
  ang_phixpphj_tmp(16,12,4)=0.086066296582387041893_dp
  !!!!
  ang_phixpphj_tmp(1,1,5)=0.33333333333333333333_dp
  ang_phixpphj_tmp(1,7,5)=-0.14907119849998597976_dp
  ang_phixpphj_tmp(1,9,5)=-0.25819888974716112568_dp
  ang_phixpphj_tmp(2,2,5)=0.60000000000000000000_dp
  ang_phixpphj_tmp(2,10,5)=-0.20701966780270626534_dp
  ang_phixpphj_tmp(2,12,5)=-0.16035674514745463081_dp
  ang_phixpphj_tmp(3,3,5)=0.20000000000000000000_dp
  ang_phixpphj_tmp(3,13,5)=-0.13093073414159542876_dp
  ang_phixpphj_tmp(3,15,5)=-0.16903085094570331550_dp
  ang_phixpphj_tmp(4,4,5)=0.20000000000000000000_dp
  ang_phixpphj_tmp(4,14,5)=-0.053452248382484876937_dp
  ang_phixpphj_tmp(4,16,5)=-0.20701966780270626534_dp
  ang_phixpphj_tmp(5,5,5)=0.42857142857142857143_dp
  ang_phixpphj_tmp(6,6,5)=0.42857142857142857143_dp
  ang_phixpphj_tmp(7,1,5)=-0.14907119849998597976_dp
  ang_phixpphj_tmp(7,7,5)=0.23809523809523809524_dp
  ang_phixpphj_tmp(7,9,5)=0.16495721976846450415_dp
  ang_phixpphj_tmp(8,8,5)=0.14285714285714285714_dp
  ang_phixpphj_tmp(9,1,5)=-0.25819888974716112568_dp
  ang_phixpphj_tmp(9,7,5)=0.16495721976846450415_dp
  ang_phixpphj_tmp(9,9,5)=0.42857142857142857143_dp
  ang_phixpphj_tmp(10,2,5)=-0.20701966780270626534_dp
  ang_phixpphj_tmp(10,10,5)=0.44444444444444444444_dp
  ang_phixpphj_tmp(10,12,5)=0.086066296582387041893_dp
  ang_phixpphj_tmp(11,11,5)=0.33333333333333333333_dp
  ang_phixpphj_tmp(12,2,5)=-0.16035674514745463081_dp
  ang_phixpphj_tmp(12,10,5)=0.086066296582387041893_dp
  ang_phixpphj_tmp(12,12,5)=0.40000000000000000000_dp
  ang_phixpphj_tmp(13,3,5)=-0.13093073414159542876_dp
  ang_phixpphj_tmp(13,13,5)=0.24444444444444444444_dp
  ang_phixpphj_tmp(13,15,5)=0.17213259316477408379_dp
  ang_phixpphj_tmp(14,4,5)=-0.053452248382484876937_dp
  ang_phixpphj_tmp(14,14,5)=0.13333333333333333333_dp
  ang_phixpphj_tmp(14,16,5)=0.086066296582387041893_dp
  ang_phixpphj_tmp(15,3,5)=-0.16903085094570331550_dp
  ang_phixpphj_tmp(15,13,5)=0.17213259316477408379_dp
  ang_phixpphj_tmp(15,15,5)=0.33333333333333333333_dp
  ang_phixpphj_tmp(16,4,5)=-0.20701966780270626534_dp
  ang_phixpphj_tmp(16,14,5)=0.086066296582387041893_dp
  ang_phixpphj_tmp(16,16,5)=0.44444444444444444444_dp
  !!!!!
  ang_phixpphj_tmp(1,6,6)=0.25819888974716112568_dp
  ang_phixpphj_tmp(2,3,6)=0.20000000000000000000_dp
  ang_phixpphj_tmp(2,13,6)=-0.13093073414159542876_dp
  ang_phixpphj_tmp(2,15,6)=-0.16903085094570331550_dp
  ang_phixpphj_tmp(3,2,6)=0.20000000000000000000_dp
  ang_phixpphj_tmp(3,12,6)=0.21380899352993950775_dp
  ang_phixpphj_tmp(4,11,6)=0.16903085094570331550_dp
  ang_phixpphj_tmp(5,8,6)=0.14285714285714285714_dp
  ang_phixpphj_tmp(6,1,6)=0.25819888974716112568_dp
  ang_phixpphj_tmp(6,7,6)=0.082478609884232252073_dp
  ang_phixpphj_tmp(6,9,6)=-0.14285714285714285714_dp
  ang_phixpphj_tmp(7,6,6)=0.082478609884232252073_dp
  ang_phixpphj_tmp(8,5,6)=0.14285714285714285714_dp
  ang_phixpphj_tmp(9,6,6)=-0.14285714285714285714_dp
  ang_phixpphj_tmp(10,15,6)=0.13608276348795433879_dp
  ang_phixpphj_tmp(11,4,6)=0.16903085094570331550_dp
  ang_phixpphj_tmp(11,14,6)=0.10540925533894597773_dp
  ang_phixpphj_tmp(11,16,6)=-0.13608276348795433879_dp
  ang_phixpphj_tmp(12,3,6)=0.21380899352993950775_dp
  ang_phixpphj_tmp(12,13,6)=0.054433105395181735515_dp
  ang_phixpphj_tmp(12,15,6)=-0.10540925533894597773_dp
  ang_phixpphj_tmp(13,2,6)=-0.13093073414159542876_dp
  ang_phixpphj_tmp(13,12,6)=0.054433105395181735515_dp
  ang_phixpphj_tmp(14,11,6)=0.10540925533894597773_dp
  ang_phixpphj_tmp(15,2,6)=-0.16903085094570331550_dp
  ang_phixpphj_tmp(15,10,6)=0.13608276348795433879_dp
  ang_phixpphj_tmp(15,12,6)=-0.10540925533894597773_dp
  ang_phixpphj_tmp(16,11,6)=-0.13608276348795433879_dp
  !!!!
  ang_phixpphj_tmp(1,8,7)=0.25819888974716112568_dp
  ang_phixpphj_tmp(2,11,7)=0.16903085094570331550_dp
  ang_phixpphj_tmp(3,4,7)=0.20000000000000000000_dp
  ang_phixpphj_tmp(3,14,7)=0.21380899352993950775_dp
  ang_phixpphj_tmp(4,3,7)=0.20000000000000000000_dp
  ang_phixpphj_tmp(4,13,7)=-0.13093073414159542876_dp
  ang_phixpphj_tmp(4,15,7)=0.16903085094570331550_dp
  ang_phixpphj_tmp(5,6,7)=0.14285714285714285714_dp
  ang_phixpphj_tmp(6,5,7)=0.14285714285714285714_dp
  ang_phixpphj_tmp(7,8,7)=0.082478609884232252073_dp
  ang_phixpphj_tmp(8,1,7)=0.25819888974716112568_dp
  ang_phixpphj_tmp(8,7,7)=0.082478609884232252073_dp
  ang_phixpphj_tmp(8,9,7)=0.14285714285714285714_dp
  ang_phixpphj_tmp(9,8,7)=0.14285714285714285714_dp
  ang_phixpphj_tmp(10,11,7)=0.13608276348795433879_dp
  ang_phixpphj_tmp(11,2,7)=0.16903085094570331550_dp
  ang_phixpphj_tmp(11,10,7)=0.13608276348795433879_dp
  ang_phixpphj_tmp(11,12,7)=0.10540925533894597773_dp
  ang_phixpphj_tmp(12,11,7)=0.10540925533894597773_dp
  ang_phixpphj_tmp(13,4,7)=-0.13093073414159542876_dp
  ang_phixpphj_tmp(13,14,7)=0.054433105395181735515_dp
  ang_phixpphj_tmp(14,3,7)=0.21380899352993950775_dp
  ang_phixpphj_tmp(14,13,7)=0.054433105395181735515_dp
  ang_phixpphj_tmp(14,15,7)=0.10540925533894597773_dp
  ang_phixpphj_tmp(15,4,7)=0.16903085094570331550_dp
  ang_phixpphj_tmp(15,14,7)=0.10540925533894597773_dp
  ang_phixpphj_tmp(15,16,7)=0.13608276348795433879_dp
  ang_phixpphj_tmp(16,15,7)=0.13608276348795433879_dp
  !!!!!
  ang_phixpphj_tmp(1,6,8)=0.25819888974716112568_dp
  ang_phixpphj_tmp(2,3,8)=0.20000000000000000000_dp
  ang_phixpphj_tmp(2,13,8)=-0.13093073414159542876_dp
  ang_phixpphj_tmp(2,15,8)=-0.16903085094570331550_dp
  ang_phixpphj_tmp(3,2,8)=0.20000000000000000000_dp
  ang_phixpphj_tmp(3,12,8)=0.21380899352993950775_dp
  ang_phixpphj_tmp(4,11,8)=0.16903085094570331550_dp
  ang_phixpphj_tmp(5,8,8)=0.14285714285714285714_dp
  ang_phixpphj_tmp(6,1,8)=0.25819888974716112568_dp
  ang_phixpphj_tmp(6,7,8)=0.082478609884232252073_dp
  ang_phixpphj_tmp(6,9,8)=-0.14285714285714285714_dp
  ang_phixpphj_tmp(7,6,8)=0.082478609884232252073_dp
  ang_phixpphj_tmp(8,5,8)=0.14285714285714285714_dp
  ang_phixpphj_tmp(9,6,8)=-0.14285714285714285714_dp
  ang_phixpphj_tmp(10,15,8)=0.13608276348795433879_dp
  ang_phixpphj_tmp(11,4,8)=0.16903085094570331550_dp
  ang_phixpphj_tmp(11,14,8)=0.10540925533894597773_dp
  ang_phixpphj_tmp(11,16,8)=-0.13608276348795433879_dp
  ang_phixpphj_tmp(12,3,8)=0.21380899352993950775_dp
  ang_phixpphj_tmp(12,13,8)=0.054433105395181735515_dp
  ang_phixpphj_tmp(12,15,8)=-0.10540925533894597773_dp
  ang_phixpphj_tmp(13,2,8)=-0.13093073414159542876_dp
  ang_phixpphj_tmp(13,12,8)=0.054433105395181735515_dp
  ang_phixpphj_tmp(14,11,8)=0.10540925533894597773_dp
  ang_phixpphj_tmp(15,2,8)=-0.16903085094570331550_dp
  ang_phixpphj_tmp(15,10,8)=0.13608276348795433879_dp
  ang_phixpphj_tmp(15,12,8)=-0.10540925533894597773_dp
  ang_phixpphj_tmp(16,11,8)=-0.13608276348795433879_dp
  !!!!!
  ang_phixpphj_tmp(1,1,9)=0.33333333333333333333_dp
  ang_phixpphj_tmp(1,7,9)=0.29814239699997195952_dp
  ang_phixpphj_tmp(2,2,9)=0.20000000000000000000_dp
  ang_phixpphj_tmp(2,12,9)=0.21380899352993950775_dp
  ang_phixpphj_tmp(3,3,9)=0.60000000000000000000_dp
  ang_phixpphj_tmp(3,13,9)=0.26186146828319085752_dp
  ang_phixpphj_tmp(4,4,9)=0.20000000000000000000_dp
  ang_phixpphj_tmp(4,14,9)=0.21380899352993950775_dp
  ang_phixpphj_tmp(5,5,9)=0.14285714285714285714_dp
  ang_phixpphj_tmp(6,6,9)=0.42857142857142857143_dp
  ang_phixpphj_tmp(7,1,9)=0.29814239699997195952_dp
  ang_phixpphj_tmp(7,7,9)=0.52380952380952380952_dp
  ang_phixpphj_tmp(8,8,9)=0.42857142857142857143_dp
  ang_phixpphj_tmp(9,9,9)=0.14285714285714285714_dp
  ang_phixpphj_tmp(10,10,9)=0.11111111111111111111_dp
  ang_phixpphj_tmp(11,11,9)=0.33333333333333333333_dp
  ang_phixpphj_tmp(12,2,9)=0.21380899352993950775_dp
  ang_phixpphj_tmp(12,12,9)=0.46666666666666666667_dp
  ang_phixpphj_tmp(13,3,9)=0.26186146828319085752_dp
  ang_phixpphj_tmp(13,13,9)=0.51111111111111111111_dp
  ang_phixpphj_tmp(14,4,9)=0.21380899352993950775_dp
  ang_phixpphj_tmp(14,14,9)=0.46666666666666666667_dp
  ang_phixpphj_tmp(15,15,9)=0.33333333333333333333_dp
  ang_phixpphj_tmp(16,16,9)=0.11111111111111111111_dp
  !!!!!
  ang_phixpphj_tmp(1,7,10)=-0.44721359549995793928_dp
  ang_phixpphj_tmp(1,9,10)=0.12909944487358056284_dp
  ang_phixpphj_tmp(2,2,10)=0.050000000000000000000_dp
  ang_phixpphj_tmp(2,10,10)=0.10350983390135313267_dp
  ang_phixpphj_tmp(2,12,10)=-0.21380899352993950775_dp
  ang_phixpphj_tmp(3,3,10)=-0.20000000000000000000_dp
  ang_phixpphj_tmp(3,13,10)=-0.52372293656638171504_dp
  ang_phixpphj_tmp(3,15,10)=0.084515425472851657751_dp
  ang_phixpphj_tmp(4,4,10)=0.15000000000000000000_dp
  ang_phixpphj_tmp(4,14,10)=-0.64142698058981852324_dp
  ang_phixpphj_tmp(4,16,10)=0.10350983390135313267_dp
  ang_phixpphj_tmp(5,5,10)=0.14285714285714285714_dp
  ang_phixpphj_tmp(6,6,10)=-0.035714285714285714286_dp
  ang_phixpphj_tmp(7,7,10)=-0.14285714285714285714_dp
  ang_phixpphj_tmp(7,9,10)=0.041239304942116126036_dp
  ang_phixpphj_tmp(8,8,10)=-0.10714285714285714286_dp
  ang_phixpphj_tmp(9,7,10)=-0.24743582965269675622_dp
  ang_phixpphj_tmp(9,9,10)=0.14285714285714285714_dp
  ang_phixpphj_tmp(10,2,10)=0.034503277967117710890_dp
  ang_phixpphj_tmp(10,10,10)=0.16666666666666666667_dp
  ang_phixpphj_tmp(10,12,10)=-0.19364916731037084426_dp
  ang_phixpphj_tmp(12,2,10)=0.053452248382484876937_dp
  ang_phixpphj_tmp(12,10,10)=0.064549722436790281420_dp
  ang_phixpphj_tmp(12,12,10)=-0.050000000000000000000_dp
  ang_phixpphj_tmp(13,3,10)=0.13093073414159542876_dp
  ang_phixpphj_tmp(13,13,10)=-0.13333333333333333333_dp
  ang_phixpphj_tmp(13,15,10)=0.12909944487358056284_dp
  ang_phixpphj_tmp(14,4,10)=0.16035674514745463081_dp
  ang_phixpphj_tmp(14,14,10)=-0.15000000000000000000_dp
  ang_phixpphj_tmp(14,16,10)=0.064549722436790281420_dp
  ang_phixpphj_tmp(15,3,10)=-0.16903085094570331550_dp
  ang_phixpphj_tmp(15,13,10)=-0.25819888974716112568_dp
  ang_phixpphj_tmp(16,4,10)=0.034503277967117710890_dp
  ang_phixpphj_tmp(16,14,10)=-0.19364916731037084426_dp
  ang_phixpphj_tmp(16,16,10)=0.16666666666666666667_dp
  !!!!!!
  ang_phixpphj_tmp(1,5,11)=0.12909944487358056284_dp
  ang_phixpphj_tmp(2,4,11)=0.050000000000000000000_dp
  ang_phixpphj_tmp(2,14,11)=-0.21380899352993950775_dp
  ang_phixpphj_tmp(2,16,11)=-0.10350983390135313267_dp
  ang_phixpphj_tmp(3,11,11)=0.084515425472851657751_dp
  ang_phixpphj_tmp(4,2,11)=0.050000000000000000000_dp
  ang_phixpphj_tmp(4,10,11)=0.10350983390135313267_dp
  ang_phixpphj_tmp(4,12,11)=-0.21380899352993950775_dp
  ang_phixpphj_tmp(5,7,11)=-0.24743582965269675622_dp
  ang_phixpphj_tmp(6,8,11)=-0.035714285714285714286_dp
  ang_phixpphj_tmp(7,5,11)=0.041239304942116126036_dp
  ang_phixpphj_tmp(8,6,11)=-0.035714285714285714286_dp
  ang_phixpphj_tmp(10,4,11)=0.034503277967117710890_dp
  ang_phixpphj_tmp(10,14,11)=-0.19364916731037084426_dp
  ang_phixpphj_tmp(11,3,11)=-0.16903085094570331550_dp
  ang_phixpphj_tmp(11,13,11)=-0.25819888974716112568_dp
  ang_phixpphj_tmp(12,4,11)=0.053452248382484876937_dp
  ang_phixpphj_tmp(12,14,11)=-0.050000000000000000000_dp
  ang_phixpphj_tmp(12,16,11)=-0.064549722436790281420_dp
  ang_phixpphj_tmp(13,11,11)=0.12909944487358056284_dp
  ang_phixpphj_tmp(14,2,11)=0.053452248382484876937_dp
  ang_phixpphj_tmp(14,10,11)=0.064549722436790281420_dp
  ang_phixpphj_tmp(14,12,11)=-0.050000000000000000000_dp
  ang_phixpphj_tmp(16,2,11)=-0.034503277967117710890_dp
  ang_phixpphj_tmp(16,12,11)=0.19364916731037084426_dp
  !!!!
  ang_phixpphj_tmp(1,8,12)=0.12909944487358056284_dp
  ang_phixpphj_tmp(2,11,12)=0.084515425472851657751_dp
  ang_phixpphj_tmp(3,4,12)=0.30000000000000000000_dp
  ang_phixpphj_tmp(3,14,12)=-0.080178372573727315405_dp
  ang_phixpphj_tmp(4,3,12)=-0.20000000000000000000_dp
  ang_phixpphj_tmp(4,13,12)=-0.52372293656638171504_dp
  ang_phixpphj_tmp(4,15,12)=0.084515425472851657751_dp
  ang_phixpphj_tmp(5,6,12)=-0.035714285714285714286_dp
  ang_phixpphj_tmp(6,5,12)=0.21428571428571428571_dp
  ang_phixpphj_tmp(7,8,12)=0.41239304942116126036_dp
  ang_phixpphj_tmp(8,7,12)=-0.74230748895809026865_dp
  ang_phixpphj_tmp(8,9,12)=0.21428571428571428571_dp
  ang_phixpphj_tmp(9,8,12)=-0.035714285714285714286_dp
  ang_phixpphj_tmp(11,2,12)=0.12677313820927748663_dp
  ang_phixpphj_tmp(11,10,12)=0.20412414523193150818_dp
  ang_phixpphj_tmp(11,12,12)=-0.31622776601683793320_dp
  ang_phixpphj_tmp(12,11,12)=0.31622776601683793320_dp
  ang_phixpphj_tmp(13,4,12)=0.13093073414159542876_dp
  ang_phixpphj_tmp(13,14,12)=0.69402209378856712782_dp
  ang_phixpphj_tmp(14,3,12)=-0.21380899352993950775_dp
  ang_phixpphj_tmp(14,13,12)=-1.1430952132988164458_dp
  ang_phixpphj_tmp(14,15,12)=0.31622776601683793320_dp
  ang_phixpphj_tmp(15,4,12)=0.12677313820927748663_dp
  ang_phixpphj_tmp(15,14,12)=-0.31622776601683793320_dp
  ang_phixpphj_tmp(15,16,12)=0.20412414523193150818_dp
  !!!!!
  ang_phixpphj_tmp(1,5,13)=0.12909944487358056284_dp
  ang_phixpphj_tmp(2,4,13)=0.050000000000000000000_dp
  ang_phixpphj_tmp(2,14,13)=-0.21380899352993950775_dp
  ang_phixpphj_tmp(2,16,13)=-0.10350983390135313267_dp
  ang_phixpphj_tmp(3,11,13)=0.084515425472851657751_dp
  ang_phixpphj_tmp(4,2,13)=0.050000000000000000000_dp
  ang_phixpphj_tmp(4,10,13)=0.10350983390135313267_dp
  ang_phixpphj_tmp(4,12,13)=-0.21380899352993950775_dp
  ang_phixpphj_tmp(5,7,13)=-0.24743582965269675622_dp
  ang_phixpphj_tmp(6,8,13)=-0.035714285714285714286_dp
  ang_phixpphj_tmp(7,5,13)=0.041239304942116126036_dp
  ang_phixpphj_tmp(8,6,13)=-0.035714285714285714286_dp
  ang_phixpphj_tmp(10,4,13)=0.034503277967117710890_dp
  ang_phixpphj_tmp(10,14,13)=-0.19364916731037084426_dp
  ang_phixpphj_tmp(11,3,13)=-0.16903085094570331550_dp
  ang_phixpphj_tmp(11,13,13)=-0.25819888974716112568_dp
  ang_phixpphj_tmp(12,4,13)=0.053452248382484876937_dp
  ang_phixpphj_tmp(12,14,13)=-0.050000000000000000000_dp
  ang_phixpphj_tmp(12,16,13)=-0.064549722436790281420_dp
  ang_phixpphj_tmp(13,11,13)=0.12909944487358056284_dp
  ang_phixpphj_tmp(14,2,13)=0.053452248382484876937_dp
  ang_phixpphj_tmp(14,10,13)=0.064549722436790281420_dp
  ang_phixpphj_tmp(14,12,13)=-0.050000000000000000000_dp
  ang_phixpphj_tmp(16,2,13)=-0.034503277967117710890_dp
  ang_phixpphj_tmp(16,12,13)=0.19364916731037084426_dp
  !!!!!
  ang_phixpphj_tmp(1,7,14)=-0.44721359549995793928_dp
  ang_phixpphj_tmp(1,9,14)=-0.12909944487358056284_dp
  ang_phixpphj_tmp(2,2,14)=0.15000000000000000000_dp
  ang_phixpphj_tmp(2,10,14)=-0.10350983390135313267_dp
  ang_phixpphj_tmp(2,12,14)=-0.64142698058981852324_dp
  ang_phixpphj_tmp(3,3,14)=-0.20000000000000000000_dp
  ang_phixpphj_tmp(3,13,14)=-0.52372293656638171504_dp
  ang_phixpphj_tmp(3,15,14)=-0.084515425472851657751_dp
  ang_phixpphj_tmp(4,4,14)=0.050000000000000000000_dp
  ang_phixpphj_tmp(4,14,14)=-0.21380899352993950775_dp
  ang_phixpphj_tmp(4,16,14)=-0.10350983390135313267_dp
  ang_phixpphj_tmp(5,5,14)=0.14285714285714285714_dp
  ang_phixpphj_tmp(6,6,14)=-0.10714285714285714286_dp
  ang_phixpphj_tmp(7,7,14)=-0.14285714285714285714_dp
  ang_phixpphj_tmp(7,9,14)=-0.041239304942116126036_dp
  ang_phixpphj_tmp(8,8,14)=-0.035714285714285714286_dp
  ang_phixpphj_tmp(9,7,14)=0.24743582965269675622_dp
  ang_phixpphj_tmp(9,9,14)=0.14285714285714285714_dp
  ang_phixpphj_tmp(10,2,14)=-0.034503277967117710890_dp
  ang_phixpphj_tmp(10,10,14)=0.16666666666666666667_dp
  ang_phixpphj_tmp(10,12,14)=0.19364916731037084426_dp
  ang_phixpphj_tmp(12,2,14)=0.16035674514745463081_dp
  ang_phixpphj_tmp(12,10,14)=-0.064549722436790281420_dp
  ang_phixpphj_tmp(12,12,14)=-0.15000000000000000000_dp
  ang_phixpphj_tmp(13,3,14)=0.13093073414159542876_dp
  ang_phixpphj_tmp(13,13,14)=-0.13333333333333333333_dp
  ang_phixpphj_tmp(13,15,14)=-0.12909944487358056284_dp
  ang_phixpphj_tmp(14,4,14)=0.053452248382484876937_dp
  ang_phixpphj_tmp(14,14,14)=-0.050000000000000000000_dp
  ang_phixpphj_tmp(14,16,14)=-0.064549722436790281420_dp
  ang_phixpphj_tmp(15,3,14)=0.16903085094570331550_dp
  ang_phixpphj_tmp(15,13,14)=0.25819888974716112568_dp
  ang_phixpphj_tmp(16,4,14)=-0.034503277967117710890_dp
  ang_phixpphj_tmp(16,14,14)=0.19364916731037084426_dp
  ang_phixpphj_tmp(16,16,14)=0.16666666666666666667_dp
  !!!!!
  ang_phixpphj_tmp(1,6,15)=0.12909944487358056284_dp
  ang_phixpphj_tmp(2,3,15)=-0.20000000000000000000_dp
  ang_phixpphj_tmp(2,13,15)=-0.52372293656638171504_dp
  ang_phixpphj_tmp(2,15,15)=-0.084515425472851657751_dp
  ang_phixpphj_tmp(3,2,15)=0.30000000000000000000_dp
  ang_phixpphj_tmp(3,12,15)=-0.080178372573727315405_dp
  ang_phixpphj_tmp(4,11,15)=0.084515425472851657751_dp
  ang_phixpphj_tmp(5,8,15)=-0.035714285714285714286_dp
  ang_phixpphj_tmp(6,7,15)=-0.74230748895809026865_dp
  ang_phixpphj_tmp(6,9,15)=-0.21428571428571428571_dp
  ang_phixpphj_tmp(7,6,15)=0.41239304942116126036_dp
  ang_phixpphj_tmp(8,5,15)=0.21428571428571428571_dp
  ang_phixpphj_tmp(9,6,15)=0.035714285714285714286_dp
  ang_phixpphj_tmp(11,4,15)=0.12677313820927748663_dp
  ang_phixpphj_tmp(11,14,15)=-0.31622776601683793320_dp
  ang_phixpphj_tmp(11,16,15)=-0.20412414523193150818_dp
  ang_phixpphj_tmp(12,3,15)=-0.21380899352993950775_dp
  ang_phixpphj_tmp(12,13,15)=-1.1430952132988164458_dp
  ang_phixpphj_tmp(12,15,15)=-0.31622776601683793320_dp
  ang_phixpphj_tmp(13,2,15)=0.13093073414159542876_dp
  ang_phixpphj_tmp(13,12,15)=0.69402209378856712782_dp
  ang_phixpphj_tmp(14,11,15)=0.31622776601683793320_dp
  ang_phixpphj_tmp(15,2,15)=-0.12677313820927748663_dp
  ang_phixpphj_tmp(15,10,15)=0.20412414523193150818_dp
  ang_phixpphj_tmp(15,12,15)=0.31622776601683793320_dp
  !!!!!!
  ang_phixpphj_tmp(1,8,16)=0.77459666924148337704_dp
  ang_phixpphj_tmp(2,11,16)=0.67612340378281326201_dp
  ang_phixpphj_tmp(3,4,16)=-0.20000000000000000000_dp
  ang_phixpphj_tmp(3,14,16)=0.85523597411975803099_dp
  ang_phixpphj_tmp(4,3,16)=0.80000000000000000000_dp
  ang_phixpphj_tmp(4,13,16)=-0.52372293656638171504_dp
  ang_phixpphj_tmp(4,15,16)=0.67612340378281326201_dp
  ang_phixpphj_tmp(5,6,16)=0.71428571428571428571_dp
  ang_phixpphj_tmp(6,5,16)=-0.28571428571428571429_dp
  ang_phixpphj_tmp(7,8,16)=-0.74230748895809026865_dp
  ang_phixpphj_tmp(8,7,16)=0.98974331861078702487_dp
  ang_phixpphj_tmp(8,9,16)=-0.28571428571428571429_dp
  ang_phixpphj_tmp(9,8,16)=0.71428571428571428571_dp
  ang_phixpphj_tmp(10,11,16)=0.81649658092772603273_dp
  ang_phixpphj_tmp(11,2,16)=-0.16903085094570331550_dp
  ang_phixpphj_tmp(11,10,16)=-0.40824829046386301637_dp
  ang_phixpphj_tmp(11,12,16)=0.94868329805051379960_dp
  ang_phixpphj_tmp(12,11,16)=-0.63245553203367586640_dp
  ang_phixpphj_tmp(13,4,16)=0.13093073414159542876_dp
  ang_phixpphj_tmp(13,14,16)=-1.1430952132988164458_dp
  ang_phixpphj_tmp(14,3,16)=-0.21380899352993950775_dp
  ang_phixpphj_tmp(14,13,16)=1.3063945294843616524_dp
  ang_phixpphj_tmp(14,15,16)=-0.63245553203367586640_dp
  ang_phixpphj_tmp(15,4,16)=-0.16903085094570331550_dp
  ang_phixpphj_tmp(15,14,16)=0.94868329805051379960_dp
  ang_phixpphj_tmp(15,16,16)=-0.40824829046386301637_dp
  ang_phixpphj_tmp(16,15,16)=0.81649658092772603273_dp
  !!!!!
  ang_phixpphj_tmp(1,6,17)=0.77459666924148337704_dp
  ang_phixpphj_tmp(2,3,17)=0.80000000000000000000_dp
  ang_phixpphj_tmp(2,13,17)=-0.52372293656638171504_dp
  ang_phixpphj_tmp(2,15,17)=-0.67612340378281326201_dp
  ang_phixpphj_tmp(3,2,17)=-0.20000000000000000000_dp
  ang_phixpphj_tmp(3,12,17)=0.85523597411975803099_dp
  ang_phixpphj_tmp(4,11,17)=0.67612340378281326201_dp
  ang_phixpphj_tmp(5,8,17)=0.71428571428571428571_dp
  ang_phixpphj_tmp(6,7,17)=0.98974331861078702487_dp
  ang_phixpphj_tmp(6,9,17)=0.28571428571428571429_dp
  ang_phixpphj_tmp(7,6,17)=-0.74230748895809026865_dp
  ang_phixpphj_tmp(8,5,17)=-0.28571428571428571429_dp
  ang_phixpphj_tmp(9,6,17)=-0.71428571428571428571_dp
  ang_phixpphj_tmp(10,15,17)=0.81649658092772603273_dp
  ang_phixpphj_tmp(11,4,17)=-0.16903085094570331550_dp
  ang_phixpphj_tmp(11,14,17)=0.94868329805051379960_dp
  ang_phixpphj_tmp(11,16,17)=0.40824829046386301637_dp
  ang_phixpphj_tmp(12,3,17)=-0.21380899352993950775_dp
  ang_phixpphj_tmp(12,13,17)=1.3063945294843616524_dp
  ang_phixpphj_tmp(12,15,17)=0.63245553203367586640_dp
  ang_phixpphj_tmp(13,2,17)=0.13093073414159542876_dp
  ang_phixpphj_tmp(13,12,17)=-1.1430952132988164458_dp
  ang_phixpphj_tmp(14,11,17)=-0.63245553203367586640_dp
  ang_phixpphj_tmp(15,2,17)=0.16903085094570331550_dp
  ang_phixpphj_tmp(15,10,17)=-0.40824829046386301637_dp
  ang_phixpphj_tmp(15,12,17)=-0.94868329805051379960_dp
  ang_phixpphj_tmp(16,11,17)=-0.81649658092772603273_dp
  !!!!!
  ang_phixpphj_tmp(1,7,18)=0.89442719099991587856_dp
  ang_phixpphj_tmp(2,2,18)=-0.20000000000000000000_dp
  ang_phixpphj_tmp(2,12,18)=0.85523597411975803099_dp
  ang_phixpphj_tmp(3,3,18)=0.40000000000000000000_dp
  ang_phixpphj_tmp(3,13,18)=1.0474458731327634301_dp
  ang_phixpphj_tmp(4,4,18)=-0.20000000000000000000_dp
  ang_phixpphj_tmp(4,14,18)=0.85523597411975803099_dp
  ang_phixpphj_tmp(5,5,18)=-0.28571428571428571429_dp
  ang_phixpphj_tmp(6,6,18)=0.14285714285714285714_dp
  ang_phixpphj_tmp(7,7,18)=0.28571428571428571429_dp
  ang_phixpphj_tmp(8,8,18)=0.14285714285714285714_dp
  ang_phixpphj_tmp(9,9,18)=-0.28571428571428571429_dp
  ang_phixpphj_tmp(10,10,18)=-0.33333333333333333333_dp
  ang_phixpphj_tmp(12,2,18)=-0.21380899352993950775_dp
  ang_phixpphj_tmp(12,12,18)=0.20000000000000000000_dp
  ang_phixpphj_tmp(13,3,18)=-0.26186146828319085752_dp
  ang_phixpphj_tmp(13,13,18)=0.26666666666666666667_dp
  ang_phixpphj_tmp(14,4,18)=-0.21380899352993950775_dp
  ang_phixpphj_tmp(14,14,18)=0.20000000000000000000_dp
  ang_phixpphj_tmp(16,16,18)=-0.33333333333333333333_dp
  !!!!!!
  ang_phixpphj_tmp(1,9,19)=0.64549722436790281420_dp
  ang_phixpphj_tmp(2,2,19)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(2,10,19)=0.72456883730947192869_dp
  ang_phixpphj_tmp(3,15,19)=0.59160797830996160426_dp
  ang_phixpphj_tmp(4,4,19)=0.25000000000000000000_dp
  ang_phixpphj_tmp(4,16,19)=0.72456883730947192869_dp
  ang_phixpphj_tmp(6,6,19)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(7,9,19)=-0.28867513459481288225_dp
  ang_phixpphj_tmp(8,8,19)=0.25000000000000000000_dp
  ang_phixpphj_tmp(10,2,19)=-0.24152294576982397623_dp
  ang_phixpphj_tmp(10,12,19)=0.064549722436790281420_dp
  ang_phixpphj_tmp(12,10,19)=-0.19364916731037084426_dp
  ang_phixpphj_tmp(12,12,19)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(13,15,19)=-0.38729833462074168852_dp
  ang_phixpphj_tmp(14,14,19)=0.25000000000000000000_dp
  ang_phixpphj_tmp(14,16,19)=-0.19364916731037084426_dp
  ang_phixpphj_tmp(16,4,19)=-0.24152294576982397623_dp
  ang_phixpphj_tmp(16,14,19)=0.064549722436790281420_dp
  !!!!!
  ang_phixpphj_tmp(1,5,20)=0.64549722436790281420_dp
  ang_phixpphj_tmp(2,4,20)=0.75000000000000000000_dp
  ang_phixpphj_tmp(2,16,20)=-0.72456883730947192869_dp
  ang_phixpphj_tmp(3,11,20)=0.59160797830996160426_dp
  ang_phixpphj_tmp(4,2,20)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(4,10,20)=0.72456883730947192869_dp
  ang_phixpphj_tmp(5,9,20)=1.0000000000000000000_dp
  ang_phixpphj_tmp(6,8,20)=0.75000000000000000000_dp
  ang_phixpphj_tmp(7,5,20)=-0.28867513459481288225_dp
  ang_phixpphj_tmp(8,6,20)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(9,5,20)=-1.0000000000000000000_dp
  ang_phixpphj_tmp(10,4,20)=-0.24152294576982397623_dp
  ang_phixpphj_tmp(10,14,20)=0.064549722436790281420_dp
  ang_phixpphj_tmp(10,16,20)=1.5000000000000000000_dp
  ang_phixpphj_tmp(11,15,20)=1.0000000000000000000_dp
  ang_phixpphj_tmp(12,14,20)=0.75000000000000000000_dp
  ang_phixpphj_tmp(12,16,20)=0.19364916731037084426_dp
  ang_phixpphj_tmp(13,11,20)=-0.38729833462074168852_dp
  ang_phixpphj_tmp(14,10,20)=-0.19364916731037084426_dp
  ang_phixpphj_tmp(14,12,20)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(15,11,20)=-1.0000000000000000000_dp
  ang_phixpphj_tmp(16,2,20)=0.24152294576982397623_dp
  ang_phixpphj_tmp(16,10,20)=-1.5000000000000000000_dp
  ang_phixpphj_tmp(16,12,20)=-0.064549722436790281420_dp
  !!!!!
  ang_phixpphj_tmp(1,8,21)=0.64549722436790281420_dp
  ang_phixpphj_tmp(2,11,21)=0.59160797830996160426_dp
  ang_phixpphj_tmp(3,4,21)=0.50000000000000000000_dp
  ang_phixpphj_tmp(3,14,21)=0.93541434669348534640_dp
  ang_phixpphj_tmp(4,15,21)=0.59160797830996160426_dp
  ang_phixpphj_tmp(5,6,21)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(6,5,21)=0.50000000000000000000_dp
  ang_phixpphj_tmp(7,8,21)=0.57735026918962576451_dp
  ang_phixpphj_tmp(8,9,21)=0.50000000000000000000_dp
  ang_phixpphj_tmp(9,8,21)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(10,11,21)=-0.40824829046386301637_dp
  ang_phixpphj_tmp(11,2,21)=-0.29580398915498080213_dp
  ang_phixpphj_tmp(11,10,21)=0.61237243569579452455_dp
  ang_phixpphj_tmp(11,12,21)=-0.31622776601683793320_dp
  ang_phixpphj_tmp(12,11,21)=0.63245553203367586640_dp
  ang_phixpphj_tmp(13,14,21)=0.61237243569579452455_dp
  ang_phixpphj_tmp(14,15,21)=0.63245553203367586640_dp
  ang_phixpphj_tmp(15,4,21)=-0.29580398915498080213_dp
  ang_phixpphj_tmp(15,14,21)=-0.31622776601683793320_dp
  ang_phixpphj_tmp(15,16,21)=0.61237243569579452455_dp
  ang_phixpphj_tmp(16,15,21)=-0.40824829046386301637_dp
  !!!!!
  ang_phixpphj_tmp(1,5,22)=0.64549722436790281420_dp
  ang_phixpphj_tmp(2,4,22)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(2,16,22)=-0.72456883730947192869_dp
  ang_phixpphj_tmp(3,11,22)=0.59160797830996160426_dp
  ang_phixpphj_tmp(4,2,22)=0.75000000000000000000_dp
  ang_phixpphj_tmp(4,10,22)=0.72456883730947192869_dp
  ang_phixpphj_tmp(5,9,22)=-1.0000000000000000000_dp
  ang_phixpphj_tmp(6,8,22)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(7,5,22)=-0.28867513459481288225_dp
  ang_phixpphj_tmp(8,6,22)=0.75000000000000000000_dp
  ang_phixpphj_tmp(9,5,22)=1.0000000000000000000_dp
  ang_phixpphj_tmp(10,4,22)=-0.24152294576982397623_dp
  ang_phixpphj_tmp(10,14,22)=0.064549722436790281420_dp
  ang_phixpphj_tmp(10,16,22)=-1.5000000000000000000_dp
  ang_phixpphj_tmp(11,15,22)=-1.0000000000000000000_dp
  ang_phixpphj_tmp(12,14,22)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(12,16,22)=0.19364916731037084426_dp
  ang_phixpphj_tmp(13,11,22)=-0.38729833462074168852_dp
  ang_phixpphj_tmp(14,10,22)=-0.19364916731037084426_dp
  ang_phixpphj_tmp(14,12,22)=0.75000000000000000000_dp
  ang_phixpphj_tmp(15,11,22)=1.0000000000000000000_dp
  ang_phixpphj_tmp(16,2,22)=0.24152294576982397623_dp
  ang_phixpphj_tmp(16,10,22)=1.5000000000000000000_dp
  ang_phixpphj_tmp(16,12,22)=-0.064549722436790281420_dp
  !!!!!
  ang_phixpphj_tmp(1,9,23)=-0.64549722436790281420_dp
  ang_phixpphj_tmp(2,2,23)=0.25000000000000000000_dp
  ang_phixpphj_tmp(2,10,23)=-0.72456883730947192869_dp
  ang_phixpphj_tmp(3,15,23)=-0.59160797830996160426_dp
  ang_phixpphj_tmp(4,4,23)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(4,16,23)=-0.72456883730947192869_dp
  ang_phixpphj_tmp(6,6,23)=0.25000000000000000000_dp
  ang_phixpphj_tmp(7,9,23)=0.28867513459481288225_dp
  ang_phixpphj_tmp(8,8,23)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(10,2,23)=0.24152294576982397623_dp
  ang_phixpphj_tmp(10,12,23)=-0.064549722436790281420_dp
  ang_phixpphj_tmp(12,10,23)=0.19364916731037084426_dp
  ang_phixpphj_tmp(12,12,23)=0.25000000000000000000_dp
  ang_phixpphj_tmp(13,15,23)=0.38729833462074168852_dp
  ang_phixpphj_tmp(14,14,23)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(14,16,23)=0.19364916731037084426_dp
  ang_phixpphj_tmp(16,4,23)=0.24152294576982397623_dp
  ang_phixpphj_tmp(16,14,23)=-0.064549722436790281420_dp
  !!!!!
  ang_phixpphj_tmp(1,6,24)=0.64549722436790281420_dp
  ang_phixpphj_tmp(2,15,24)=-0.59160797830996160426_dp
  ang_phixpphj_tmp(3,2,24)=0.50000000000000000000_dp
  ang_phixpphj_tmp(3,12,24)=0.93541434669348534640_dp
  ang_phixpphj_tmp(4,11,24)=0.59160797830996160426_dp
  ang_phixpphj_tmp(5,8,24)=-0.25000000000000000000_dp
  ang_phixpphj_tmp(6,9,24)=-0.50000000000000000000_dp
  ang_phixpphj_tmp(7,6,24)=0.57735026918962576451_dp
  ang_phixpphj_tmp(8,5,24)=0.50000000000000000000_dp
  ang_phixpphj_tmp(9,6,24)=0.25000000000000000000_dp
  ang_phixpphj_tmp(10,15,24)=-0.40824829046386301637_dp
  ang_phixpphj_tmp(11,4,24)=-0.29580398915498080213_dp
  ang_phixpphj_tmp(11,14,24)=-0.31622776601683793320_dp
  ang_phixpphj_tmp(11,16,24)=-0.61237243569579452455_dp
  ang_phixpphj_tmp(12,15,24)=-0.63245553203367586640_dp
  ang_phixpphj_tmp(13,12,24)=0.61237243569579452455_dp
  ang_phixpphj_tmp(14,11,24)=0.63245553203367586640_dp
  ang_phixpphj_tmp(15,2,24)=0.29580398915498080213_dp
  ang_phixpphj_tmp(15,10,24)=0.61237243569579452455_dp
  ang_phixpphj_tmp(15,12,24)=0.31622776601683793320_dp
  ang_phixpphj_tmp(16,11,24)=0.40824829046386301637_dp
  
  ang_phixpphj(:,:,:)=ang_phixpphj_tmp(1:mpsang**2,1:mpsang**2,:)


  end subroutine set_x_nabla_ylm
  !!***
!----------------------------------------------------------------------
