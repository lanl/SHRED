...
!MPI public procedures
 ...
 public :: xmpi_abort                 ! Wrapper for MPI_ABORT
 public :: xmpi_comm_rank             ! Wrapper for MPI_COMM_RANK
 public :: xmpi_comm_size             ! Wrapper for MPI_COMM_SIZE
 public :: xmpi_barrier               ! Wrapper for MPI_BARRIER
 public :: xmpi_wait                  ! Wrapper for MPI_WAIT
 public :: xmpi_waitall               ! Wrapper for MPI_WAITALL
 public :: xmpi_iprobe                ! Wrapper for MPI_IPROBE

!----------------------------------------------------------------------
!MPI private procedures
 private :: xmpi_get_tag_ub           ! Get MPI_TAG_UB attribute

!----------------------------------------------------------------------
!MPI generic interfaces

 public :: xmpi_allgather             ! Wrapper for MPI_ALLGATHER
 ...
 public :: xmpi_allgatherv            ! Wrapper for MPI_ALLGATHERV
 interface xmpi_allgatherv
  module procedure xmpi_allgatherv_int1d
  module procedure xmpi_allgatherv_dp1d
  module procedure xmpi_allgatherv_dp2d
 end interface xmpi_allgatherv

 public :: xmpi_scatterv              ! Wrapper for MPI_SCATTERV
 interface xmpi_scatterv
  module procedure xmpi_scatterv_int1d
  module procedure xmpi_scatterv_dp1d
  module procedure xmpi_scatterv_dp2d
 end interface xmpi_scatterv

 public :: xmpi_alltoall              ! Wrapper for MPI_ALLTOALL
 interface xmpi_alltoall
  module procedure xmpi_alltoall_int1d
  module procedure xmpi_alltoall_dp1d
  module procedure xmpi_alltoall_dp2d
 end interface xmpi_alltoall

 public :: xmpi_alltoallv             ! Wrapper for MPI_ALLTOALLV
 interface xmpi_alltoallv
  module procedure xmpi_alltoallv_int1d
  module procedure xmpi_alltoallv_dp1d
  module procedure xmpi_alltoallv_dp2d
 end interface xmpi_alltoallv

 public :: xmpi_bcast                 ! Wrapper for MPI_BCAST
 interface xmpi_bcast
  module procedure xmpi_bcast_int
 ...
 public :: xmpi_gather                ! Wrapper for MPI_GATHER
 interface xmpi_gather
  module procedure xmpi_gather_int1d
  module procedure xmpi_gather_dp1d
  module procedure xmpi_gather_dp2d
 end interface xmpi_gather

 public :: xmpi_gatherv               ! Wrapper for MPI_GATHERV
 interface xmpi_gatherv
  module procedure xmpi_gatherv_int1d
  module procedure xmpi_gatherv_dp1d
  module procedure xmpi_gatherv_dp2d
 end interface xmpi_gatherv

 public :: xmpi_recv                  ! Wrapper for MPI_RECV
 interface xmpi_recv
 ...
 public :: xmpi_irecv                 ! Wrapper for MPI_IRECV
 ...
 public :: xmpi_send                  ! Wrapper for MPI_SEND
 interface xmpi_send
 ...
 public :: xmpi_isend                 ! Wrapper for MPI_ISEND
 ...
 public :: xmpi_exch                  ! Wrapper for MPI_SEND/MPI_RECV
 interface xmpi_exch
 ...
 public :: xmpi_sum                   ! Wrapper for MPI_ALLREDUCE(SUM)
 interface xmpi_sum
  module procedure xmpi_sum_int
  module procedure xmpi_sum_int1d
  module procedure xmpi_sum_dp1d
...
! *************************************************************************
 ier=0
#if defined HAVE_MPI
 if (spaceComm /= xmpi_comm_self .and. spaceComm /= xmpi_comm_null) then
   call MPI_ALLGATHER(xval,nelem,MPI_INTEGER,recvbuf,nelem,MPI_INTEGER,spaceComm,ier)
 else if (spaceComm == xmpi_comm_self) then
...
!!****f* ABINIT/xmpi_allgatherv_int1d
!! NAME
!!  xmpi_allgatherv_int1d
!!
!! FUNCTION
...
subroutine xmpi_allgatherv_int1d(xval,nelem,recvbuf,recvcounts,displs,spaceComm,ier)
...
#endif
end subroutine xmpi_allgatherv_int1d
!!***

!!****f* ABINIT/xmpi_allgatherv_dp1d
!! NAME
!!  xmpi_allgatherv_dp1d
!!
!! FUNCTION
...
subroutine xmpi_allgatherv_dp1d(xval,nelem,recvbuf,recvcounts,displs,spaceComm,ier)
...
#endif
end subroutine xmpi_allgatherv_dp1d
!!***
...
subroutine xmpi_allgatherv_dp2d(xval,nelem,recvbuf,recvcounts,displs,spaceComm,ier)
...
subroutine xmpi_scatterv_int1d(xval,sendcounts,displs,recvbuf,recvcount,root,spaceComm,ier)
...
#endif
end subroutine xmpi_scatterv_int1d
!!***

!!****f* ABINIT/xmpi_scatterv_dp1d
!! NAME
!!  xmpi_scatterv_dp1d
!!
!! FUNCTION
...
subroutine xmpi_scatterv_dp1d(xval,sendcounts,displs,recvbuf,recvcount,root,spaceComm,ier)
...
#endif
end subroutine xmpi_scatterv_dp1d
!!***
...
subroutine xmpi_scatterv_dp2d(xval,sendcounts,displs,recvbuf,recvcount,root,spaceComm,ier)
...
subroutine xmpi_alltoall_int1d(xval,sendsize,recvbuf,recvsize,spaceComm,ier)
...
&   recvsize, MPI_INTEGER, spaceComm, ier)
 ...
 recvbuf=xval
#endif
end subroutine xmpi_alltoall_int1d
!!***

!!****f* ABINIT/xmpi_alltoall_dp1d
!! NAME
!!  xmpi_alltoall_dp1d
!!
!! FUNCTION
...
subroutine xmpi_alltoall_dp1d(xval,sendsize,recvbuf,recvsize,spaceComm,ier)
...
&   recvsize, MPI_DOUBLE_PRECISION, spaceComm, ier)
 ...
 recvbuf=xval
#endif
end subroutine xmpi_alltoall_dp1d
!!***
...
!!****f* ABINIT/xmpi_alltoallv_int1d
!! NAME
!!  xmpi_alltoallv_int1d
!!
!! FUNCTION
...
subroutine xmpi_alltoallv_int1d(xval,sendcnts,sdispls,recvbuf,recvcnts,rdispls,comm,ier)
...
#endif
end subroutine xmpi_alltoallv_int1d
!!***
...
subroutine xmpi_bcast_int(xval,master,spaceComm,ier)
...
subroutine xmpi_gather_int1d(xval,sendcount,recvbuf,recvcount,root,spaceComm,ier)
...
! *************************************************************************
 ...
 recvbuf=xval
#endif
end subroutine xmpi_gather_int1d
!!***

!!****f* ABINIT/xmpi_gather_dp1d
!! NAME
!!  xmpi_gather_dp1d
!!
!! FUNCTION
...
subroutine xmpi_gather_dp1d(xval,sendcount,recvbuf,recvcount,root,spaceComm,ier)
...
&   root,spaceComm,ier)
 ...
 recvbuf=xval
#endif
end subroutine xmpi_gather_dp1d
!!***
...
subroutine xmpi_gather_dp2d(xval,sendcount,recvbuf,recvcount,root,spaceComm,ier)
...
subroutine xmpi_gatherv_int1d(xval,nelem,recvbuf,recvcounts,displs,root,spaceComm,ier)
...
#endif
end subroutine xmpi_gatherv_int1d
!!***

!!****f* ABINIT/xmpi_gatherv_dp1d
!! NAME
!!  xmpi_gatherv_dp1d
!!
!! FUNCTION
...
subroutine xmpi_gatherv_dp1d(xval,nelem,recvbuf,recvcounts,displs,root,spaceComm,ier)
...
#endif
end subroutine xmpi_gatherv_dp1d
!!***
...
! *************************************************************************
 ...
 if (spaceComm /= xmpi_comm_self .and. spaceComm /= xmpi_comm_null) then
   n1=size(xval,dim=1)
   my_tag = MOD(tag,xmpi_get_tag_ub(spaceComm))
...
subroutine xmpi_exch_int1d(vsend,n1,sender,vrecv,recever,spaceComm,ier)
...
! *************************************************************************
 ier=0
#if defined HAVE_MPI
 if (sender==recever.or.spaceComm==xmpi_comm_null.or.(n1==0)) return
 call MPI_COMM_RANK(spaceComm,me,ier)
 tag = MOD(n1,xmpi_get_tag_ub(spaceComm))
 if (recever==me) then
...
subroutine xmpi_exch_dp1d(vsend,n1,sender,vrecv,recever,spaceComm,ier)
...
! *************************************************************************
 ier=0
#if defined HAVE_MPI
 if (sender==recever.or.spaceComm==xmpi_comm_null.or.(nt==0)) return
 call MPI_COMM_RANK(spaceComm,me,ier)
 tag = MOD(nt,xmpi_get_tag_ub(spaceComm))
 if (recever==me) then
...
subroutine xmpi_sum_int1d(xval,comm,ier)
...
#endif
end subroutine xmpi_sum_int1d
!!***

!!****f* ABINIT/xmpi_sum_dp1d
!! NAME
!!  xmpi_sum_dp1d
!!
!! FUNCTION
...
subroutine xmpi_sum_dp1d(xval,comm,ier)
...
!!
!! FUNCTION
!!  MPI_ALLREDUCE(SUM) for 4D double precision arrays
!!
!! INPUTS
!!  comm= MPI communicator
!!
...
!Local variables-------------------
#if defined HAVE_MPI
 integer :: n1,n2,n3,n4,nproc
#if !defined HAVE_MPI2 || !defined HAVE_MPI2_INPLACE
 real(dp) :: xsum(size(xval,dim=1),size(xval,dim=2),size(xval,dim=3),size(xval,dim=4))
#endif
#endif
...
! *************************************************************************
 ...
 if (comm /= xmpi_comm_self .and. comm /= xmpi_comm_null) then
   call MPI_COMM_SIZE(comm,nproc,ier)
   if (nproc /= 1) then
     n1=size(xval,dim=1) ; n2=size(xval,dim=2) ; n3=size(xval,dim=3); n4=size(xval,dim=4)
#if defined HAVE_MPI2 && defined HAVE_MPI2_INPLACE
...
!!
!! FUNCTION
!!  MPI_ALLREDUCE(SUM) for 5D double precision arrays
!!
!! INPUTS
!!  comm= MPI communicator
!!
...
!!
!! OUTPUT
!!  xmpi_get_tag_ub=value for the MPI_TAG_UB attribute attached to comm
!!
!! PARENTS
!!
!! CHILDREN
...
function xmpi_get_tag_ub(comm)

!Arguments-------------------------
 integer, intent(in) :: comm
 integer :: xmpi_get_tag_ub
...
!call MPI_Comm_get_attr(comm MPI_TAG_UB,attribute_val,lflag,ier)
 ...
 if (lflag) xmpi_get_tag_ub = attribute_val

#else
 xmpi_get_tag_ub=32767
#endif

end function xmpi_get_tag_ub
!!***
