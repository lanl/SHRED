...
implicit none
private
public pi, pi54, e_, i_, bohr2ang, ang2bohr, Ha2eV, kB, K2au, density2gcm3, u2au, &
    s2au, kJmol2Ha, au2GPa, FMT_int, FMT_real, FMT_signed_int
...
real(dp), parameter :: pi54  = 4.1825133983795990759571891061046_dp
...
!converts a.u. to GigaPasacals

real(dp), parameter :: au2GPa=29421.02648438959

CHARACTER(LEN=*), PARAMETER   :: FMT_real = "(*(2x,E24.11e3))"
CHARACTER(LEN=*), PARAMETER   :: FMT_int = "(*(2x,I6.6))"
CHARACTER(LEN=*), PARAMETER   :: FMT_signed_int = "(*(2x,I7.6))"
